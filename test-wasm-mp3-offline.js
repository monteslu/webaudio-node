...
console.log('\n🧪 Testing WASM MP3 decoding and offline rendering...\n');
...
console.log('\nRendering 5 seconds of audio with WASM...');
...
writeWav('/tmp/wasm-mp3-output.wav', rendered);

console.log('\n' + (max > 0.01 ? '✅ WASM MP3 DECODING WORKS!' : '❌ NO AUDIO RENDERED'));
console.log('\nPlay with: afplay /tmp/wasm-mp3-output.wav');
