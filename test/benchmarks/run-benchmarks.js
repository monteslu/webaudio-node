...
for (const impl of implementations) {
	...
	try {
		...
		results[impl.name].bufferPlayback = await benchmarkBufferPlayback(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].heavyProcessing = await benchmarkHeavyProcessing(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].constantSource = await benchmarkConstantSource(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].delayModulation = await benchmarkDelayModulation(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].filterModulation = await benchmarkFilterModulation(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].envelopeGenerator = await benchmarkEnvelopeGenerator(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].ringModulation = await benchmarkRingModulation(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].granularSynthesis = await benchmarkGranularSynthesis(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].channelCounts = await benchmarkChannelCounts(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].audioListener = await benchmarkAudioListener(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].distanceModels = await benchmarkDistanceModels(impl.OfflineAudioContext, 10);
	} catch (e) {
	...
	try {
		...
		results[impl.name].analyserProcessOverhead = await benchmarkAnalyserProcessOverhead(impl.OfflineAudioContext, 10);
	} catch (e) {
